  ...
  return (
    <div>
      <div
        ...
        className="d-flex justify-content-center bg-footer text-light"
      >
            ...
            <ul className="p-0" style={{ color: "gray", listStyle: "none" }}>
              <li>
                <Link
                  ...
                  to="/about"
                >
                  <span className="hov-link">About us</span>
                </Link>
              </li>
              ...
              <li>
                <Link
                  ...
                  to="/services"
                >
                  <span className="hov-link">Services</span>
                </Link>
              </li>
              ...
              <li>
                <Link
                  ...
                  to="/contact"
                >
                  <span className="hov-link">Contact us</span>
                </Link>
              </li>
            </ul>
          </div>
      ...
      <div className="bg-footer">
        <p className="text-secondary text-center pt-4 pb-3 my-0">
          All Rights Reserved &copy; Codatory
        </p>
      </div>
    </div>
  );
